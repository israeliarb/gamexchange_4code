              ...
              children: <Widget>[
                ...
                if(_isLoading)
                  ...
                  MaterialButton( //login
                    ...
                    child: Text("Login", style: TextStyle(fontWeight: FontWeight.w400, fontSize: 18, color: Colors.black
                      ),
                    ),
                    onPressed: _submit,
                  ),
                ...
                FlatButton(
                  minWidth: 200,
                  height: 40,
                  child: Text("Cadastre-se", style: TextStyle(fontWeight: FontWeight.w400, fontSize: 18)),
                  onPressed: () => Navigator.pushNamed(context, '/registro-card')
                ),
              ],
            ),
          ),
